    ...
    <div className="auth-screen">
      <div className="auth-layout">
        ...
        <aside className="auth-info-card">
          <p className="section-kicker">{t('home.howItWorks')}</p>
          <div className="auth-info-grid">
            <article className="auth-info-item">
              <h3>{t('auth.accountApplicant')}</h3>
              <p className="muted">{t('auth.helperApplicant')}</p>
            </article>
            <article className="auth-info-item">
              <h3>{t('auth.accountCompany')}</h3>
              <p className="muted">{t('auth.helperCompany')}</p>
            </article>
          </div>
        </aside>
      </div>
